...
<div class="viewport-header playfair">
    <div class="text-center p-5">
        <h1 class="text-white text-5xl pb-5 uppercase"><?php the_field('title'); ?></h1>
        <h3 class="text-white text-2xl pb-5"><?php the_field('subtitle'); ?></h3>
        <?php
